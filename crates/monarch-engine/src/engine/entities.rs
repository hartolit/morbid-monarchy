...
impl Default for EntityPhysicsConfig {
    fn default() -> Self {
        Self {
            ...
            resistance_multiplier: 3.5,
            force_to_volume_factor: 1.2,
            min_deformation_energy: 200.0,
            energy_to_deformation_scale: 0.001,
            max_deformation_size_ratio: 0.2,
            cost_displace_granular: 1.5,
            cost_crush_terrain: 4.5,
